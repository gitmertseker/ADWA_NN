...
def train_net(train_data, val_data, batch_size, num_epochs=100, lr=0.001):
    ...
    x_val, s_val, w_val, y_val = val_data
...
def utility(costmaps, states, costweights, rewards):
    ...
    val_data = (x_val, s_val, w_val, y_val)
...
def main(costmaps, states, costweights, rewards):
    ...
    train_data, test_data, val_data = utility(costmaps, states, costweights, rewards)

    # Train network
    net = train_net(train_data, val_data, batch_size)

    # Test network
    test_accuracy, f1 = test_net(net, test_data, batch_size)
